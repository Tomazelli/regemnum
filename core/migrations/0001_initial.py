# Generated by Django 3.2.9 on 2021-11-19 05:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pontosDeAtencao', models.TextField(default='#', verbose_name='Pontos de atenção')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, verbose_name='Atualização')),
                ('active', models.BooleanField(default=True, verbose_name='Ativo')),
                ('monitorar', models.CharField(default='#', max_length=10, verbose_name='Monitorar')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataInicialContribuicoes', models.DateField(verbose_name='Data inicial das Contribuições (AAAA-MM-DD)')),
                ('dataFinalContribuicoes', models.DateField(verbose_name='Data final das Contribuições (AAAA-MM-DD)')),
                ('dataConvocacao', models.DateField(verbose_name='Data da Convocação (AAAA-MM-DD)')),
                ('dataUltimaAtualizacao', models.DateField(auto_now=True, verbose_name='Atualização (AAAA-MM-DD)')),
                ('dataProdutoFinal', models.DateField(verbose_name='Data produto final (AAAA-MM-DD)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conteudo', models.TextField(default='#', verbose_name='Conteudo da contribuicao')),
